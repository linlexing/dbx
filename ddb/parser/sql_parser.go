...
func sqlParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 73, 425, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		60, 0, 7, 2, 0, 68, 68, 70, 70, 1, 0, 54, 56, 2, 0, 1, 1, 3, 3, 1, 0, 4,
		5, 1, 0, 26, 29, 1, 0, 9, 22, 1, 0, 47, 48, 458, 0, 64, 1, 0, 0, 0, 2,
		...
		1, 0, 0, 0, 60, 411, 1, 0, 0, 0, 62, 65, 5, 1, 0, 0, 63, 65, 5, 68, 0,
		0, 64, 62, 1, 0, 0, 0, 64, 63, 1, 0, 0, 0, 65, 1, 1, 0, 0, 0, 66, 67, 5,
		68, 0, 0, 67, 3, 1, 0, 0, 0, 68, 69, 5, 68, 0, 0, 69, 5, 1, 0, 0, 0, 70,
		71, 5, 68, 0, 0, 71, 7, 1, 0, 0, 0, 72, 73, 7, 0, 0, 0, 73, 9, 1, 0, 0,
		0, 74, 75, 7, 1, 0, 0, 75, 76, 5, 57, 0, 0, 76, 11, 1, 0, 0, 0, 77, 79,
		5, 59, 0, 0, 78, 80, 5, 60, 0, 0, 79, 78, 1, 0, 0, 0, 79, 80, 1, 0, 0,
		0, 80, 13, 1, 0, 0, 0, 81, 82, 5, 66, 0, 0, 82, 15, 1, 0, 0, 0, 83, 84,
		5, 69, 0, 0, 84, 17, 1, 0, 0, 0, 85, 86, 5, 71, 0, 0, 86, 19, 1, 0, 0,
		0, 87, 88, 6, 10, -1, 0, 88, 89, 5, 24, 0, 0, 89, 90, 3, 22, 11, 0, 90,
		91, 5, 25, 0, 0, 91, 92, 3, 38, 19, 0, 92, 94, 3, 42, 21, 0, 93, 95, 3,
		...
		13, 0, 126, 128, 5, 23, 0, 0, 127, 126, 1, 0, 0, 0, 127, 128, 1, 0, 0,
		...
		0, 143, 189, 1, 0, 0, 0, 144, 145, 5, 61, 0, 0, 145, 146, 5, 62, 0, 0,
		146, 147, 3, 46, 23, 0, 147, 148, 5, 63, 0, 0, 148, 156, 3, 26, 13, 0,
		149, 150, 5, 62, 0, 0, 150, 151, 3, 46, 23, 0, 151, 152, 5, 63, 0, 0, 152,
		153, 3, 26, 13, 0, 153, 155, 1, 0, 0, 0, 154, 149, 1, 0, 0, 0, 155, 158,
		1, 0, 0, 0, 156, 154, 1, 0, 0, 0, 156, 157, 1, 0, 0, 0, 157, 161, 1, 0,
		0, 0, 158, 156, 1, 0, 0, 0, 159, 160, 5, 64, 0, 0, 160, 162, 3, 26, 13,
		0, 161, 159, 1, 0, 0, 0, 161, 162, 1, 0, 0, 0, 162, 163, 1, 0, 0, 0, 163,
		164, 5, 65, 0, 0, 164, 189, 1, 0, 0, 0, 165, 166, 5, 61, 0, 0, 166, 167,
		3, 26, 13, 0, 167, 168, 5, 62, 0, 0, 168, 169, 3, 26, 13, 0, 169, 170,
		5, 63, 0, 0, 170, 178, 3, 26, 13, 0, 171, 172, 5, 62, 0, 0, 172, 173, 3,
		26, 13, 0, 173, 174, 5, 63, 0, 0, 174, 175, 3, 26, 13, 0, 175, 177, 1,
		0, 0, 0, 176, 171, 1, 0, 0, 0, 177, 180, 1, 0, 0, 0, 178, 176, 1, 0, 0,
		0, 178, 179, 1, 0, 0, 0, 179, 183, 1, 0, 0, 0, 180, 178, 1, 0, 0, 0, 181,
		182, 5, 64, 0, 0, 182, 184, 3, 26, 13, 0, 183, 181, 1, 0, 0, 0, 183, 184,
		1, 0, 0, 0, 184, 185, 1, 0, 0, 0, 185, 186, 5, 65, 0, 0, 186, 189, 1, 0,
		0, 0, 187, 189, 5, 45, 0, 0, 188, 132, 1, 0, 0, 0, 188, 134, 1, 0, 0, 0,
		...
		18, 0, 216, 217, 5, 8, 0, 0, 217, 226, 1, 0, 0, 0, 218, 219, 5, 30, 0,
		...
		0, 230, 231, 5, 8, 0, 0, 231, 242, 1, 0, 0, 0, 232, 233, 5, 31, 0, 0, 233,
		242, 3, 36, 18, 0, 234, 235, 5, 53, 0, 0, 235, 236, 5, 7, 0, 0, 236, 237,
		3, 36, 18, 0, 237, 238, 5, 23, 0, 0, 238, 239, 3, 4, 2, 0, 239, 240, 5,
		...
		263, 39, 1, 0, 0, 0, 264, 262, 1, 0, 0, 0, 265, 267, 5, 72, 0, 0, 266,
		265, 1, 0, 0, 0, 266, 267, 1, 0, 0, 0, 267, 268, 1, 0, 0, 0, 268, 277,
		3, 2, 1, 0, 269, 271, 5, 72, 0, 0, 270, 269, 1, 0, 0, 0, 270, 271, 1, 0,
		...
		0, 0, 0, 282, 283, 1, 0, 0, 0, 283, 284, 5, 58, 0, 0, 284, 285, 3, 46,
		23, 0, 285, 287, 1, 0, 0, 0, 286, 278, 1, 0, 0, 0, 287, 290, 1, 0, 0, 0,
		288, 286, 1, 0, 0, 0, 288, 289, 1, 0, 0, 0, 289, 43, 1, 0, 0, 0, 290, 288,
		1, 0, 0, 0, 291, 292, 5, 32, 0, 0, 292, 293, 3, 46, 23, 0, 293, 45, 1,
		0, 0, 0, 294, 295, 6, 23, -1, 0, 295, 296, 3, 26, 13, 0, 296, 297, 3, 48,
		24, 0, 297, 298, 3, 26, 13, 0, 298, 362, 1, 0, 0, 0, 299, 301, 3, 26, 13,
		0, 300, 302, 5, 40, 0, 0, 301, 300, 1, 0, 0, 0, 301, 302, 1, 0, 0, 0, 302,
		303, 1, 0, 0, 0, 303, 304, 5, 42, 0, 0, 304, 305, 3, 26, 13, 0, 305, 306,
		5, 43, 0, 0, 306, 307, 3, 26, 13, 0, 307, 362, 1, 0, 0, 0, 308, 310, 3,
		26, 13, 0, 309, 311, 5, 40, 0, 0, 310, 309, 1, 0, 0, 0, 310, 311, 1, 0,
		0, 0, 311, 312, 1, 0, 0, 0, 312, 313, 5, 44, 0, 0, 313, 314, 5, 7, 0, 0,
		...
		0, 0, 323, 362, 1, 0, 0, 0, 324, 326, 3, 26, 13, 0, 325, 327, 5, 40, 0,
		0, 326, 325, 1, 0, 0, 0, 326, 327, 1, 0, 0, 0, 327, 328, 1, 0, 0, 0, 328,
		329, 5, 44, 0, 0, 329, 330, 5, 7, 0, 0, 330, 331, 3, 20, 10, 0, 331, 332,
		5, 8, 0, 0, 332, 362, 1, 0, 0, 0, 333, 335, 3, 26, 13, 0, 334, 336, 5,
		40, 0, 0, 335, 334, 1, 0, 0, 0, 335, 336, 1, 0, 0, 0, 336, 337, 1, 0, 0,
		0, 337, 338, 5, 51, 0, 0, 338, 339, 3, 26, 13, 0, 339, 362, 1, 0, 0, 0,
		340, 341, 3, 26, 13, 0, 341, 343, 5, 41, 0, 0, 342, 344, 5, 40, 0, 0, 343,
		342, 1, 0, 0, 0, 343, 344, 1, 0, 0, 0, 344, 345, 1, 0, 0, 0, 345, 346,
		5, 45, 0, 0, 346, 362, 1, 0, 0, 0, 347, 348, 5, 52, 0, 0, 348, 349, 5,
		7, 0, 0, 349, 350, 3, 20, 10, 0, 350, 351, 5, 8, 0, 0, 351, 362, 1, 0,
		0, 0, 352, 354, 5, 72, 0, 0, 353, 352, 1, 0, 0, 0, 353, 354, 1, 0, 0, 0,
		354, 355, 1, 0, 0, 0, 355, 356, 5, 7, 0, 0, 356, 357, 3, 46, 23, 0, 357,
		358, 5, 8, 0, 0, 358, 362, 1, 0, 0, 0, 359, 360, 5, 40, 0, 0, 360, 362,
		...
		371, 1, 0, 0, 0, 363, 364, 10, 2, 0, 0, 364, 365, 5, 43, 0, 0, 365, 370,
		3, 46, 23, 3, 366, 367, 10, 1, 0, 0, 367, 368, 5, 46, 0, 0, 368, 370, 3,
		...
		5, 33, 0, 0, 377, 378, 5, 34, 0, 0, 378, 383, 3, 52, 26, 0, 379, 380, 5,
		...
		389, 5, 39, 0, 0, 389, 390, 3, 46, 23, 0, 390, 55, 1, 0, 0, 0, 391, 392,
		5, 35, 0, 0, 392, 393, 5, 34, 0, 0, 393, 398, 3, 58, 29, 0, 394, 395, 5,
		...
		5, 36, 0, 0, 406, 410, 5, 37, 0, 0, 407, 408, 5, 36, 0, 0, 408, 410, 5,
		38, 0, 0, 409, 405, 1, 0, 0, 0, 409, 407, 1, 0, 0, 0, 409, 410, 1, 0, 0,
		0, 410, 59, 1, 0, 0, 0, 411, 422, 5, 49, 0, 0, 412, 413, 3, 14, 7, 0, 413,
		414, 5, 2, 0, 0, 414, 416, 1, 0, 0, 0, 415, 412, 1, 0, 0, 0, 415, 416,
		1, 0, 0, 0, 416, 417, 1, 0, 0, 0, 417, 423, 3, 14, 7, 0, 418, 419, 3, 14,
		7, 0, 419, 420, 5, 50, 0, 0, 420, 421, 3, 14, 7, 0, 421, 423, 1, 0, 0,
...
const (
	...
	SqlParserELSE            = 64
	SqlParserEND             = 65
	SqlParserDECIMAL_LITERAL = 66
	SqlParserFLOAT_LITERAL   = 67
	SqlParserID              = 68
	SqlParserTEXT_STRING     = 69
	SqlParserTEXT_ALIAS      = 70
	SqlParserBIND_VARIABLE   = 71
	SqlParserCOMMENT         = 72
	SqlParserWS              = 73
)
...
func (p *SqlParser) SelectElement() (localctx ISelectElementContext) {
	...
	if (int64((_la-23)) & ^0x3f) == 0 && ((int64(1)<<(_la-23))&175921860444161) != 0 {
		p.SetState(127)
		p.GetErrorHandler().Sync(p)
		_la = p.GetTokenStream().LA(1)
...
func (p *SqlParser) ComparisonOperator() (localctx IComparisonOperatorContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&8388096) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
